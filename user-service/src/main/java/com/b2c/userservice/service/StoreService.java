...
public class StoreService {
	...
	public Store updateStoreData(long id, String storename, String storelicno, String storepanno, String storelicenseimage, 
		...
		return iStoreDao.updateStoreResult1(id, storename, storelicno, storepanno, storelicenseimage, storeaddress, storecity, 
				storepincode, storelat, storelong, storepicimagename, storecontactdetails, ownername, ownercontact, owneremail, 
				storetype, storestate, createdby);
